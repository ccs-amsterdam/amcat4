...
def test_aggregate_datefunctions(index):
    ...
    upload(index, docs)
    assert q(Axis("date", interval="day")) == {date(2018, 1, 1): 2, date(2018, 1, 11): 1, date(2018, 1, 17): 2, date(2018, 3, 7): 1}
    ...
    assert q(Axis("date", interval="month"), Axis("date", interval="weeknr")) == {1: 2, 2: 1, 3: 2, 10: 1}
