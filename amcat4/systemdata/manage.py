...
def create_or_update_systemdata(rm_pending_migrations: bool = True) -> int:
    """
    ...
    active_version = active_systemdata_status(LATEST_VERSION, rm_pending_migrations)
...
def active_systemdata_status(latest_version: int, rm_pending_migrations: bool = True) -> int | None:
    """
